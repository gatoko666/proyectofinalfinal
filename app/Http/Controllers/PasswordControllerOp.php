...
class PasswordControllerOp extends Controller
{
     ...
     // $semana=$data["semana"];
        ...
        Mail::send('partials.resetpasswordop', $data,function ($message)use ($correo) {                                      
                                            ...
                                            try     {
                                              ...
                                              $message->to($correo);  
                                              $message->subject('Reinicio Contraseña '); 
    ...
    public function showPasswordResetForm($token)
    {
        ...
        if ( !$tokenData ) return redirect()->to('/')->with('success', 'Token Inválido.');  //redirect them anywhere you want if the token does not exist.
