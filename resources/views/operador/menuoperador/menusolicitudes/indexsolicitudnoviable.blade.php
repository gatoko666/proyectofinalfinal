                                    ...
                                    <div class="container">
                                            ...
                                            <nav>
                                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                      <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#dia-libre" role="tab" aria-controls="nav-home" aria-selected="true">Solicitud Día libre</a>
                                                      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#sol-vacacion" role="tab" aria-controls="nav-profile" aria-selected="false">Solicitud Vacaciones</a>
                                                      <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#sol-dia-administrativo" role="tab" aria-controls="nav-contact" aria-selected="false">Solicitud Día Administrativo</a>
                                                      <a class="nav-item nav-link" id="nav-contact4-tab" data-toggle="tab" href="#sol-licencia" role="tab" aria-controls="nav-contact" aria-selected="false">Solicitud Informar Licencia</a>
                                                      <a class="nav-item nav-link" id="nav-contact5-tab" data-toggle="tab" href="#sol-ausencia" role="tab" aria-controls="nav-contact" aria-selected="false">Solicitud Ausencia</a>
                                                    </div>
                                                  </nav>
                                                  <div class="tab-content" id="nav-tabContent">
                                                    <div class="tab-pane fade show active" id="dia-libre" role="tabpanel" aria-labelledby="nav-home-tab">
                                                            <form action="{{route('solicitardialibre')}}" method="POST">                                                             
                                                                    {{ csrf_field() }}   
                                                                    ...
                                                                    <input type="hidden" name="DiaLibre" value="DiaLibre">
                                                                    <div class="form-group row"  id="solicitud-dialibre">
                                                                          ...
                                                                          <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                  <input id="datepicker1" name="desdeDiaLibre" width="276" />
                                                                                              <script>
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                  <input id="datepicker2" name="hastaDiaLibre" width="276" />
                                                                                  <script>
