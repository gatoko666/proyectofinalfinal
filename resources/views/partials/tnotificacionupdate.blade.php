                        ...
                        <tr>
                            <td style="padding:0 15px;">
                                ...
                                <p style="color:#171f23de; font-size:15px;line-height:24px; margin:0;">
									...
									Estimado operador Sr(a). {{$nombretrabajador}}, se a realizado la actualización de un turno previamente publicado  correspondiente a la semana {{$semana}}, favor de revisarlo en el sitio web.
									<br>
