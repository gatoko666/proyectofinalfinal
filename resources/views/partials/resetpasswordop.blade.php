    	...
    	<table style="background-color: #f2f8f9; max-width:670px;  margin:0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
    			  <td style="text-align:center;">
					   <h1>Adturn Sistema de turnos</h1>
            </td>
         	</tr>
            <tr>
                    ...
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12);-moz-box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12);box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12)">
                        ...
                        <tr>
                            <td style="padding:0 15px;">
                                <h1 style="color:#3075BA; font-weight:400; margin:0;font-size:30px;">You have requested to reset your password</h1>
                                ...
                                <a href="{{url('reset-password/'.$token).'?email='.$email}}" style="background:#3075BA;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 12px;display:inline-block;border-radius:3px;">Reset Password</a>
                            </td>
          ...
          <tr>
    			  <td style="text-align:center;">
					     <p style="font-size:14px; color:#455056bd; line-height:18px; margin:0 0 0;">Powered by <strong>Bootstrap 4 Admin Theme by Propeller</strong></p>
            </td>
         	</tr>
          <tr>
  			   <td style="height:80px;">&nbsp;</td>
