                    ...
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12);-moz-box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12);box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12)">
                        ...
                        <tr>
                            <td style="padding:0 15px;">
								...
								<h1 style="color:#3075BA; font-weight:400; margin:0;font-size:30px;">
									Solicitud con estado {{$estadoSolicitud}}.
                                ...
                                <p style="color:#171f23de; font-size:15px;line-height:24px; margin:0;">
									...
									Estimado operador Sr(a). {{$nombreOperador}}, se ha cambiado el estado de su solicitud a {{$estadoSolicitud}} de  su solicitud   {{$tipoSolicitud}}, paras más detalle, revisar su solicitud en el sitio web.
                                ...
                                <a href="{{url('/index')}}" style="background:#3075BA;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 12px;display:inline-block;border-radius:3px;">
                                    Revisar Solicitud</a>
                            </td>
