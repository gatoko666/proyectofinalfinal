                        ...
                        <tr>
                            <td style="padding:0 15px;">
                                ...
                                <p style="color:#171f23de; font-size:15px;line-height:24px; margin:0;">
									...
									Estimado Supervisor Sr(a). {{$nombreAdmin}}, se a realizado la solicitud de tipo
									@if (($tiposSolicitud) ==='DiaLibre')
									Solicitud Día libre
									   @elseif  (($tiposSolicitud) ==='Vacacion')
											Solicitud Vacaciones
									   @elseif  (($tiposSolicitud) ==='DiaAdministrativo')
									   Solicitud Día Administrativo
									   @elseif  (($tiposSolicitud) ==='InformarLicencia')
									   Solicitud Informar Licencia
									   @elseif  (($tiposSolicitud) ==='InformarAusencia')
									   Solicitud Ausencia
									
									@endif
									
									 ,por el operador  {{$nombreOperador}},  favor de revisarlo en el sitio web.
									<br>
									Atentamente.
